...
from pyscada.onewire.models import (
    OneWireVariable,
    OneWireDevice,
    ExtendedOneWireDevice,
    ExtendedOneWireVariable,
)
...
class OneWireDeviceAdmin(DeviceAdmin):
    ...
    def formfield_for_foreignkey(self, db_field, request, **kwargs):
        ...
        return super(OneWireDeviceAdmin, self).formfield_for_foreignkey(
    ...
    inlines = [OneWireDeviceAdminInline]
...
class OneWireVariableAdmin(CoreVariableAdmin):
    ...
    def formfield_for_foreignkey(self, db_field, request, **kwargs):
        ...
        return super(OneWireVariableAdmin, self).formfield_for_foreignkey(
            db_field, request, **kwargs
        )
    ...
    inlines = [OneWireVariableAdminInline]
